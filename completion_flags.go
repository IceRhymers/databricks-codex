...
var flagDefs = []completion.FlagDef{
	...
	{Name: "no-otel", Description: "Disable OpenTelemetry and clear all persisted OTEL keys"},
	{Name: "no-otel-metrics", Description: "Disable metrics for this session and clear the persisted OTEL metrics key"},
	{Name: "no-otel-logs", Description: "Disable logs for this session and clear the persisted OTEL logs key"},
